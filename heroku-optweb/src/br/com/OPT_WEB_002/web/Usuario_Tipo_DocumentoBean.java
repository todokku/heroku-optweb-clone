...
public class Usuario_Tipo_DocumentoBean implements Serializable {
	...
	public String salvar(){
		...
		if(id_usuario_tipo_documento == null){
			...
			if(usuario_Tipo_DocumentoRN.carregarPorIdUsuIdTipo(usuario_Tipo_Documento.getId_usuario().getId_usuario(),usuario_Tipo_Documento.getId_tipo_documento().getId_tipo_doc()) != null){
