...
public class Layout_EmpresaDAOHibernate implements Layout_EmpresaDAO {
	...
	public List<Layout_Empresa> listarCampoReferencia(BigInteger id_tipo_doc,Integer cod_empresa, Integer cod_filial,Integer cod_unidade) {
		...
		String hql = "select tb from layout_empresa tb where tb.id_tipo_doc = :id_tipo_doc and tb.referencia = true and  tb.cod_empresa = :cod_empresa and tb.cod_filial = :cod_filial and tb.cod_unidade = :cod_unidade and tb.flag_campo = true";
