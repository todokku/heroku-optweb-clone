...
public class Usuario_Tipo_Documento implements Serializable {
	...
	public Usuario_Tipo_Documento(){
		...
		this.id_tipo_documento = tipo_documento;
	...
	public int hashCode() {
		...
		result = prime * result + ((id_tipo_documento == null) ? 0 : id_tipo_documento.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (id_tipo_documento == null) {
			if (other.id_tipo_documento != null)
				return false;
		} else if (!id_tipo_documento.equals(other.id_tipo_documento))
			return false;
		if (id_usuario == null) {
